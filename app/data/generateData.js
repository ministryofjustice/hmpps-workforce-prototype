...
const updateProbationPractitioner = probationPractitioner => Object.assign(probationPractitioner, 
  {
    allocationsInLast7: getTotalInTimePeriod(probationPractitioner.serviceUsers, 'allocationDate'),
    totalReductions: calculateTotalReductions(probationPractitioner),
    nextChange: calculateNextChange(probationPractitioner),
    pointsUsed: calculatePointsUsed(probationPractitioner),
    pointsAvailable: calculatePointsAvailable(probationPractitioner.contractedHours, totalReductions),
    capacity: Math.round((pointsUsed/pointsAvailable)*100),
